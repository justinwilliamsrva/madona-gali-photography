...
<footer style="background-color: rgba(0, 0, 0, 0.2)">
  <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
    <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
      <div class="px-5 py-2">
        <a href="/home" class="text-base text-gray-700 hover:text-gray-900"> Home </a>
      </div>
    ...
    <div class="mt-8 flex justify-center space-x-6">
      <a href="https://www.facebook.com/MadonaGaliPhotography" class="text-gray-700 hover:text-gray-900">
      ...
      <a href="mailto:madonagali@gmail.com" class="text-gray-700 hover:text-gray-900" >
    ...
    <p class="mt-8 text-center text-base text-gray-700">&copy; {{ date('Y') }} Copyright Modana Gali Photography</p>
