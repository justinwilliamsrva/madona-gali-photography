<x-guest-layout>
    ...
    <div class="min-h-[32rem] bg-[#EAF3F6]">
        <div class="relative p-4 mx-auto md:py-32 max-w-5xl sm:px-6 md:px-8" style="cursor: auto;">
            <div class="max-w-lg mx-auto overflow-hidden shadow-lg md:max-w-none md:flex">
