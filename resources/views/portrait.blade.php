<x-guest-layout>
    ...
    <div class="min-h-[32rem] bg-[#EAF3F6]">
        <div class="relative p-4 mx-auto lg:py-32 max-w-5xl sm:px-6 lg:px-8" style="cursor: auto;">
            <div class="max-w-lg mx-auto overflow-hidden shadow-lg lg:max-w-none lg:flex">
