<x-guest-layout>
  ...
  <div class="bg-[#EAF3F6]">
    ...
    <hr />
    <div id="galleries" class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
      <h1 class="text-black text-center text-4xl mb-6 font-header tracking-widest">Galleries</h1>
